...
// timers
int           via2__timer1Counter;
uint16_t      via2__timer1Latch;
int           via2__timer2Counter;
uint8_t       via2__timer2Latch;     // timer 2 latch is 8 bits
bool          via2__timer1Triggered;
bool          via2__timer2Triggered;

// CA1, CA2
uint8_t       via2__CA1;
uint8_t       via2__CA1_prev;
uint8_t       via2__CA2;
uint8_t       via2__CA2_prev;
 
// CB1, CB2
uint8_t       via2__CB1;
uint8_t       via2__CB1_prev;
uint8_t       via2__CB2;
uint8_t       via2__CB2_prev;
 
// PA, PB
uint8_t       via2__DDRA;
uint8_t       via2__DDRB;
uint8_t       via2__PA;     // what actually there is out of 6522 port A
uint8_t       via2__PB;     // what actually there is out of 6522 port B
uint8_t       via2__IRA;    // input register A
uint8_t       via2__IRB;    // input register B
uint8_t       via2__ORA;    // output register A
uint8_t       via2__ORB;    // output register B
